 ...
 *
 * @param <E>
 *            le type des éléments du multiensemble.
 */
public final class SortedBag<E extends Comparable<E>> implements Iterable<E> {
     ...
     * 
     * @param e1
     *            l'unique élément du multiensemble
     * @param <E>
     *            le type de l'élément du multiensemble
     ...
     * 
     * @param n
     *            la multiplicité de l'élément <code>e</code> (>= 0)
     * @param e
     *            l'élément du multiensemble
     * @param <E>
     *            le type de l'élément du multiensemble
     * @return un multiensemble contenant <code>n</code> occurrences de
     *         <code>e</code>
    ...
    /**
     * Crée un multiensemble contenant deux éléments, chacun avec une
     * multiplicité donnée.
     * 
     * @param n1
     *            la multiplicité de l'élément <code>e1</code> (>= 0)
     * @param e1
     *            le premier élément du multiensemble
     * @param n2
     *            la multiplicité de l'élément <code>e2</code> (>= 0)
     * @param e2
     *            le second élément du multiensemble
     * @param <E>
     *            le type des éléments du multiensemble
     * @return un multiensemble contenant <code>n1</code> occurrences de
     *         <code>e1</code>, et <code>n2</code> de <code>e2</code>
     * @throws IllegalArgumentException
     *             si <code>n1</code> ou <code>n2</code> est négatif
     */
    public static <E extends Comparable<E>> SortedBag<E> of(int n1, E e1,
            int n2, E e2) {
    ...
    /**
     * Crée un multiensemble contenant les éléments d'un itérable (p.ex. une
     * liste)
     * 
     * @param iterable
     *            l'itérable fournissant les éléments du multiensemble
     * @param <E>
     *            le type des éléments du multiensemble
     * @return un multiensemble contenant exactement les mêmes éléments que
     *         <code>iterable</code>
     */
    public static <E extends Comparable<E>> SortedBag<E> of(
            Iterable<E> iterable) {
     ...
     * 
     * @param element
     *            l'élément dont la multiplicité doit être retournée
     * @return la multiplicité de <code>element</code>, 0 s'il n'appartient pas
     *         au multiensemble
     */
    ...
    /**
     * Retourne vrai ssi l'élément donné appartient au multiensemble (au moins
     * une fois).
     * 
     * @param element
     *            l'élément dont la présence doit être testée
    ...
    /**
     * Retourne vrai ssi le multiensemble donné est un sous-ensemble de
     * celui-ci.
     * 
     * @param that
     *            le multiensemble dont on doit déterminer s'il est un
     *            sous-ensemble
     * @return vrai ssi <code>that</code> est un sous-ensemble de
     *         <code>this</code>
     */
     ...
     * 
     * @param that
     *            le multiensemble à combiner avec le récepteur
    ...
    /**
     * Retourne la différence entre le multiensemble récepteur et le
     * multiensemble donné.
     * 
     * @param that
     *            le multiensemble à combiner avec le récepteur
    ...
    public SortedBag<E> difference(SortedBag<E> that) {
        var newElements = new TreeMap<>(elements);
        that.elements.forEach((eR, nR) -> newElements.compute(eR,
                (e, n) -> n != null && n > nR ? n - nR : null));
        return new SortedBag<>(newElements);
    }

    /**
     * Retourne tous les sous-ensembles du multiensemble ayant une taille
     * donnée.
     * 
     * @param size
     *            la taille des sous-ensembles à retourner
     * @return l'ensemble des sous-ensembles de <code>this</code> de taille
     *         <code>size</code>
     * @throws IllegalArgumentException
     *             si <code>size</code> n'est pas comprise entre 0 et la taille
     *             du multiensemble
     */
    public Set<SortedBag<E>> subsetsOfSize(int size) {
        ...
        for (var e1 : elements.keySet()) {
            ...
            this.difference(s1).subsetsOfSize(size - 1)
    ...
    /**
     * Retourne une table (immuable) associant sa multiplicité à chaque élément
     * du multiensemble.
     * 
     * @return une table associant sa multiplicité à chaque élément de
     *         <code>this</code>
     */
    ...
    /**
     * Retourne l'ensemble des éléments du multiensemble. Attention : les
     * éléments apparaissant plus d'une fois dans le multiensemble
    ...
    /**
     * Retourne vrai ssi ce multiensemble est égal à l'objet donné (comparaison
     * structurelle).
     * 
     * @param that
     *            l'objet avec lequel comparer <code>this</code>
     * @return vrai ssi <code>that</code> est un multiensemble égal à
     *         <code>this</code>
     */
    @Override
     ...
     * 
     * @param <E>
     *            le type des éléments du multiensemble à bâtir.
     */
    public static final class Builder<E extends Comparable<E>> {
         ...
         * 
         * @param count
         *            le nombre d'occurrences de l'élément à ajouter
         * @param element
         *            l'élément à ajouter
         * @return le bâtisseur (<code>this</code>)
         * @throws IllegalArgumentException
         *             si <code>count</code> est négatif
         */
        public Builder<E> add(int count, E element) {
            Preconditions.checkArgument(0 <= count);
            if (count > 0)
                elements.merge(element, count, Integer::sum);
            return this;
        }
         ...
         * 
         * @param that
         *            le multiensemble dont les éléments sont à ajouter
         * @return le bâtisseur (<code>this</code>)
         */
        ...
        /**
         * Retourne un multiensemble contenant les éléments ajoutés jusqu'à
         * présent au bâtisseur.
         * 
         * @return un multiensemble contenant les éléments ajoutés à
         *         <code>this</code>
         */
